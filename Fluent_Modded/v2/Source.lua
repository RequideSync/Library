...
local Themes = {
    ...
    Bliz_T = {
		Name = "Bliz_T",
		Accent = Color3.fromRGB(100, 150, 255), -- Stroke
		AcrylicMain = Color3.fromRGB(0, 0, 0), -- Main
		AcrylicBorder = Color3.fromRGB(20, 20, 20), -- Second
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(0, 0, 0), Color3.fromRGB(0, 0, 0)),
		AcrylicNoise = 0.9,
		TitleBarLine = Color3.fromRGB(80, 120, 200), -- Divider
		Tab = Color3.fromRGB(20, 20, 20),
		Element = Color3.fromRGB(20, 20, 20),
		ElementBorder = Color3.fromRGB(100, 150, 255), -- Stroke
		InElementBorder = Color3.fromRGB(80, 120, 200), -- Divider
		ElementTransparency = 0.87,
		...
		DropdownFrame = Color3.fromRGB(20, 20, 20),
		DropdownHolder = Color3.fromRGB(0, 0, 0),
		DropdownBorder = Color3.fromRGB(100, 150, 255), -- Stroke
		DropdownOption = Color3.fromRGB(20, 20, 20),
		Keybind = Color3.fromRGB(20, 20, 20),
		Input = Color3.fromRGB(20, 20, 20),
		InputFocused = Color3.fromRGB(0, 0, 0),
		InputIndicator = Color3.fromRGB(100, 150, 255), -- Stroke
		Dialog = Color3.fromRGB(0, 0, 0),
		DialogHolder = Color3.fromRGB(20, 20, 20),
		DialogHolderLine = Color3.fromRGB(80, 120, 200), -- Divider
		DialogButton = Color3.fromRGB(0, 0, 0),
		DialogButtonBorder = Color3.fromRGB(100, 150, 255), -- Stroke
		DialogBorder = Color3.fromRGB(80, 120, 200), -- Divider
		DialogInput = Color3.fromRGB(20, 20, 20),
		DialogInputLine = Color3.fromRGB(100, 150, 255), -- Stroke
		Text = Color3.fromRGB(180, 220, 255), -- Text
		SubText = Color3.fromRGB(150, 180, 230), -- TextDark
		Hover = Color3.fromRGB(80, 120, 200), -- Divider
		HoverChange = 0.07,
	}
...
ElementsTable.ImageLabel = (function()
    local ImageLabelElement = {}
    ImageLabelElement.__index = ImageLabelElement
    ImageLabelElement.__type = "ImageLabel"

    function ImageLabelElement:New(Config)
        assert(Config.Title, "ImageLabel - Missing Title")
        assert(Config.Image, "ImageLabel - Missing Image")

        local ImageElement = Components.Element(Config.Title, "", ImageLabelElement.Container, false, Config)

        local Image = New("ImageLabel", {
            Name = "Icon",
            Parent = ImageElement.Frame,
            BackgroundTransparency = 1,
            Size = Config.Size or UDim2.fromOffset(64, 64),
            Position = Config.Position or UDim2.new(0, 10, 0, 10),
            Image = Config.Image,
            ThemeTag = {
                ImageColor3 = Config.ThemeTag or "Accent",
            },
        })
        ...
        function ImageElement:SetSize(size)
            Image.Size = size
        end

        function ImageElement:SetPosition(pos)
            Image.Position = pos
        end

        ImageElement.ImageObject = Image
