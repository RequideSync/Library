...
local SelectedThemes = getgenv().LibraryTheme or "Chili"
local OrionLib = {
	Elements = {},
	ThemeObjects = {},
	Connections = {},
    ...
    Chili = {
      Main = Color3.fromRGB(0, 0, 0), -- Preto para o fundo (背景：黒のまま)
      Second = Color3.fromRGB(20, 20, 20), -- Cinza bem escuro para contraste (セカンダリ：暗灰)
      Stroke = Color3.fromRGB(255, 100, 100), -- Vermelho claro para detalhes (明るい赤)
      Divider = Color3.fromRGB(200, 80, 80), -- Vermelho mais escuro para divisores (濃い赤)
      Text = Color3.fromRGB(255, 180, 180), -- Vermelho bem claro para textos (淡い赤/ピンク寄り)
      TextDark = Color3.fromRGB(230, 150, 150) -- Vermelho médio para texto secundário
    }
	},
