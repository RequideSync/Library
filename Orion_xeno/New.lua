...
-- Load icons from local data instead of HTTP request
local Success = true
local Response = "Using local Feather Icons"

-- Uncomment and modify the following if you want to load additional icons from a URL
--[[
Success, Response = pcall(function()
    local iconData = game:HttpGetAsync("https://raw.githubusercontent.com/your-username/your-repo/main/icons.json")
    local decoded = HttpService:JSONDecode(iconData)
    for k, v in pairs(decoded.icons or {}) do
        Icons[k] = v
    end
end)
if not Success then
    warn("\nOrion Library - Failed to load additional Feather Icons. Error: " .. tostring(Response) .. "\n")
end
]]
