...
function Library:CreateWindow(...)
	...
	local AlignMap = { Left = Enum.TextXAlignment.Left, Center = Enum.TextXAlignment.Center, Right = Enum.TextXAlignment.Right,};Config.TitleDirection = AlignMap[Config.TitleDirection] or Enum.TextXAlignment.Left
	...
	local WindowLabel = Library:CreateLabel({
		...
		TextXAlignment = Config.TitleDirection or Enum.TextXAlignment.Left;
		ZIndex = 1;
		Parent = Inner;
	});
